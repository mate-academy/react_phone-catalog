...
export const Search = () => {
  ...
  const handleSearch = (newQuery: string) => {
    ...
    if (query.trim() === '') {
      params.delete('query', String(newQuery));
    }

    params.set('query', String(newQuery));
  ...
  return (
    <div className={styles.searchlist}>
      <div className={styles.search}>
        <input value={query} type="text" placeholder="Search" className={styles.input} onChange={handleSearch(query)} />

...
+. Add `Shop by category` block with the links to `/phones`, `/tablets` and `/accessories`. Add `data-cy="categoryLinksContainer"`
to links container.
...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://IzzetYusufov.github.io/react_phone-catalog/) and add it to the PR description.

...
export function getPhoneDenails(phoneId: string) {
  return getFromServer<PhoneDetails>(`${phoneDetailUrl}/${phoneId}.json`);
}
...
export function getSugesstedProducts() {
  return getPhones()

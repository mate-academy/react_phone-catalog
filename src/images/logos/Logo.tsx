  ...
  return (
    <div className="w-full h-full">
      ...
      >
        ...
        <g transform="translate(390,8) scale(0.28)">
          <g>
            <g>
              <g>
                <path
                  fill="url(#pinkVioletUnicornGradient)"
                  d="M349.679,445.252c-0.666-15.437-3.755-52.685-18.313-74.522c-2.62-3.917-7.919-4.992-11.836-2.364
                ...
                <path
                  fill="url(#pinkVioletUnicornGradient)"
                  d="M281.6,341.333c4.71,0,8.533-3.823,8.533-8.533v-8.533c0-4.719-3.823-8.533-8.533-8.533s-8.533,3.814-8.533,8.533v8.533
                  C273.067,337.51,276.89,341.333,281.6,341.333z"
                />
                <path
                  fill="url(#pinkVioletUnicornGradient)"
                  d="M102.4,25.6c0,4.71,3.823,8.533,8.533,8.533s8.533-3.823,8.533-8.533c4.71,0,8.533-3.823,8.533-8.533
                ...
                <path
                  fill="url(#pinkVioletUnicornGradient)"
                  d="M102.4,204.8c0-4.719-3.823-8.533-8.533-8.533c-4.71,0-8.533,3.814-8.533,8.533c-4.71,0-8.533,3.814-8.533,8.533
                ...
                <path
                  fill="url(#pinkVioletUnicornGradient)"
                  d="M221.867,226.133c0-7.057-5.743-12.8-12.8-12.8c-7.057,0-12.8,5.743-12.8,12.8s5.743,12.8,12.8,12.8
                  C216.124,238.933,221.867,233.19,221.867,226.133z"
                />
                <path
                  fill="url(#pinkVioletUnicornGradient)"
                  d="M401.067,136.533c-35.26,0-59.11,8.695-60.109,9.062c-0.589,0.222-1.033,0.623-1.545,0.956
                ...
                <path
                  fill="url(#pinkVioletUnicornGradient)"
                  d="M469.333,221.867H460.8v-8.533c0-4.719-3.823-8.533-8.533-8.533c-4.71,0-8.533,3.814-8.533,8.533v8.533H435.2
                ...
                <path
                  fill="url(#pinkVioletUnicornGradient)"
                  d="M503.467,34.133c0-4.719-3.823-8.533-8.533-8.533s-8.533,3.814-8.533,8.533c-4.71,0-8.533,3.814-8.533,8.533
                ...
                <path
                  fill="url(#pinkVioletUnicornGradient)"
                  d="M171.102,304.495c-4.233,12.698-0.7,28.245,9.685,42.658C193.63,364.971,220.126,384,256,384
                ...
                <path
                  fill="url(#pinkVioletUnicornGradient)"
                  d="M315.733,226.133c0-7.057-5.743-12.8-12.8-12.8s-12.8,5.743-12.8,12.8s5.743,12.8,12.8,12.8
                  S315.733,233.19,315.733,226.133z"
                />
                <path
                  fill="url(#pinkVioletUnicornGradient)"
                  d="M230.4,341.333c4.71,0,8.533-3.823,8.533-8.533v-8.533c0-4.719-3.823-8.533-8.533-8.533c-4.71,0-8.533,3.814-8.533,8.533

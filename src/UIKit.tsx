...
export const UIKit = () => (
  <div className="container">
    ...
    <div className="section">
      <ul className="Select">
        <li className="Select__Item">One</li>
        <li className="Select__Item Select__Item--selected">Two</li>
        <li className="Select__Item">Three</li>
        <li className="Select__Item">Four</li>
        <li className="Select__Item">Five</li>
      </ul>
    </div>
  </div>
);

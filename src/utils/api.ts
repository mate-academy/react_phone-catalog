...
export const fetchPhones = async () => {
  ...
  // https://tina-moskvinova.github.io/react_phone-catalog/api/phones.json
};
...
export const fetchTablets = async () => {
  ...
  // https://tina-moskvinova.github.io/react_phone-catalog/api/tablets.json
};
...
export const fetchAccessories = async () => {
  ...
  // https://tina-moskvinova.github.io/react_phone-catalog/api/accessories.json
};
...
export const fetchProducts = async () => {
  ...
  // https://tina-moskvinova.github.io/react_phone-catalog/api/products.json
};

  ...
  return (
    ...
    >
      <div className="max-w-90 mb-6">
        <img src={getImage('img/page-not-found.png')} alt="Product not found" className="w-full h-auto" />
      </div>
      <h1 className="text-2xl sm:text-4xl font-bold text-[#0F0F11] mb-4">Page was not found</h1>
      <Link
        to="/"

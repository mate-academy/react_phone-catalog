...
import { getSuggestedProducts } from '../helpers/getProductsByCategories';
    ...
    <div className="container">
      <div className="product-details App__product-details">
              ...
              <div className="product-details__right-box">
                <div className="product-details__available">
                  ...
                  <ul className="product-details__available-list">
                    {selectedPhone?.colorsAvailable.map(color => (
                      ...
                      >
                        <div
                          className="product-details__available-item--bc-color"
                  ...
                  <ul className="product-details__available-list">
                    {selectedPhone?.capacityAvailable.map(memory => (
                      <Link
                        ...
                        className={cn('product-details__available-item--memory',
                ...
                <div className="product-details__btns">
                  <div className="product-details__btns-container">
                    <button
                      type="button"
                      className={cn('button button--product-details-add', {
                        'button--selected': generalProduct?.isAddCard,
                      })}
                      onClick={() => generalProduct && handleAddCard(
                        generalProduct, 'addCard',
                      )}
                    >
                      <p className="button__text">
                        {generalProduct?.isAddCard
                          ? 'You`ve added'
                          : 'Added to cart'}
                      </p>
                    </button>
        ...
        <section className="product-details__you-may-like">
          <ProductsSlider
            items={getSuggestedProducts(products)}

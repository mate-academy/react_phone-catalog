            ...
            <div className="Product__mainInfo">
              ...
              <div className="Product__info-wrap">
                <div className="PhoneCard__buttons-container">
                  <CartButton product={product} className="Product__button_cart PhoneCard__button" />
                  <FavouriteButton item={product} className="Product__button_favorites PhoneCard__button btn" />
                </div>

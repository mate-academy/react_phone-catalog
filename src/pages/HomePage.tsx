...
import { getDiscountProducts, getNewProducts } from '../api/products';
...
export const HomePage = () => {
  ...
  return (
    <main
      className="
        content flex w-full flex-col gap-14 overflow-hidden pb-20
        pt-6 md:gap-16 md:pt-8 lg:gap-20 lg:pt-14
      "
    >
      <section className="flex flex-col gap-6 md:gap-8 lg:gap-14">

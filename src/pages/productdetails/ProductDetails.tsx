            ...
            <div className="details__features_container">
              ...
              <div className="details__info">
                <div className="details__info__item">
                  ...
                  <h3 className="details__info__value">{product?.screen}</h3>
                </div>
                ...
                <div className="details__info__item">
                  ...
                  <h3 className="details__info__value">{product?.processor}</h3>
                </div>
                ...
                <div className="details__info__item">
                  ...
                  <h3 className="details__info__value">{product?.ram}</h3>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="details__information__specs">
              ...
              <div className="details__information__specs__info">
                <div className="details__information__specs__item">
                  <h2 className="details__information__specs__key">Screen</h2>
                  <h3

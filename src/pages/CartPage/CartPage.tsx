              ...
              <div className="cartPage__content--products">
                <div className="cartPage__content__container">
                  <ul className="cartPage__content--products__list">
                    {products.map(product => {
                      ...
                      return (
                        ...
                        >
                          <div className="cartPage__content--products__item--leftSide">
                            <button
                            ...
                            />
                            <p className="cartPage__content--products__item--name">
                              {name}
                            </p>
                          </div>
                          <div className="cartPage__content--products__item--rightSide">
                            <div className="cartPage__content--products__item--quantity">
                              <button
                                type="button"
                            ...
                            <h2 className=" cartPage__content--products__item--totalPrice">
                              {`$${fullPrice}`}
                            </h2>
                          </div>
                        </li>
                  ...
                  <div className="cartPage__content--products__bill">
                    ...
                    {message && (
                      <p className="smallText cartPage__content--products__bill--message">

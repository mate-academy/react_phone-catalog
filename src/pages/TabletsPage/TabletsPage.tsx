...
export const TabletsPage: React.FC = React.memo(() => {
  ...
  useEffect(() => {
    ...
    getProduct(NamesByCategories.Tablets)
      .then(gotProducts => {
  ...
  return (
    <>
      <Header
        withSearchBy={NamesByCategories.Tablets}
        ...
        <div className="container">
          <main className="container__content">
            <div className="product-page__way">
              <WayFromHome lastPoint={NamesByHeader.Tablets} />
            </div>

            <section className="product-page__section">
              <h1>
                {NamesBySections.Tablets}
              </h1>
              ...
              {!checkAllFiltersParam() && (
                <div className="product-page__paragraph">
                  <NoSearchResults caterogy={NamesBySections.Tablets} />
                </div>
              )}
            </section>
          </main>

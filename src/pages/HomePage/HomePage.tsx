...
export const HomePage: React.FC = () => {
  const { productsFromServer, hotPrisModels, brandNewModels } = useContext(CatalogContext);
  ...
  useEffect(() => {
    if (productsFromServer) {
      const uniqueCategories = Array.from(new Set(productsFromServer?.map((product: Product) => product.category)));
  ...
  return (
    <>
      ...
      <section className="brand-new">
        <div className="container">
          <div className="brand-new__title-box product__title-box">
            <h2 className="title brand-new__title">
              Brand new models
            </h2>
      ...
      <section className="categories">
        <div className="container">
          <h2 className="categories__title title">
            Shop by category
          </h2>
      ...
      <section className="hot-prices">
        <div className="container">
          <div className="hot-prices__title-box product__title-box">
            <h2 className="title hot-prices__title">
              Hot prices
            </h2>
            {hotPrisModels && <ProductSliderButtons

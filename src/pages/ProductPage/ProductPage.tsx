...
export const ProductPage: React.FC = () => {
  const { uniqueProductFromServer, phonesFromServer, tabletsFromServer, accessoriesFromServer} = useContext(CatalogContext);
  ...
  useEffect(() => {
    switch (currentProduct?.category) {
      case 'phones':
        setCurrentTypeProducts(useUnique(phonesFromServer)?.filter(product => product.category === 'phones') || null);
        break;
      case 'tablets':
        setCurrentTypeProducts(useUnique(tabletsFromServer)?.filter(product => product.category === 'tablets') || null);
        break;
      default:
        setCurrentTypeProducts(useUnique(accessoriesFromServer)?.filter(product => product.category === 'accessories') || null);
        break;
    }
  }, [])
        ...
        <div className="product__page">
          <div className="product__page-item product__first-info">
            ...
            <div className="product__main-info">
              ...
              <div className="product__price-action-container">
                ...
                />
                <ProductButtons
                  currentProduct={uniqueProductFromServer?.find(item => item.id === itemId)}
                />
              </div>
          ...
          <div className="may-like">
              <div className="may-like__title-box product__title-box">
                <h2 className="title may-like__title">
                  You may also like
                </h2>

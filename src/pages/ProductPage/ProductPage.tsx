...
type Props = {
  productCategiryName: NamesByCategories,
  productHaederName: NamesByHeader,
  productSectionName: NamesBySections,
};

export const ProductPage: React.FC<Props> = React.memo(({
  productCategiryName, productHaederName, productSectionName,
}) => {
  ...
  useEffect(() => {
    ...
    getProduct(productCategiryName)
      .then(gotProducts => {
  ...
  return (
    <>
      <Header
        withSearchBy={productCategiryName}
        ...
        <div className="container">
          <main className="container__content">
            <div className="product-page__way">
              <WayFromHome lastPoint={productHaederName} />
            </div>
            ...
            <section className="product-page__section">
              ...
              {!products.length && (
                <NoResults caterogy={productSectionName} />
              )}
              ...
              {!checkAllFiltersParam() && (
                <div className="product-page__paragraph">
                  <NoSearchResults caterogy={productSectionName} />
                </div>
              )}
            </section>
          </main>

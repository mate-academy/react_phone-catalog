...
export const AccessoriesPage = () => {
  ...
  const sortedAccessoriesList = getSortedProducts(dataAccessories, sort, query);

  let paginatedData = sortedAccessoriesList.slice(
    firstPageIndex,
    lastPageIndex,
  );
  ...
  const getAccessories = () => {
    const accessoriesData = products.filter(

...
import { getAccessories } from '../../helpers/apis';
    ...
    <div className="Parentcontainer">
      <div className="Tabletspage">
        <div className="Phonespage_currentpage">
          ...
          <p className="Phonespage_currentpage_pagename">Accessories</p>
        </div>

        <h1 className="Phonespage_title">Accessories</h1>
        ...
        {isLoading
          ...
          : (
            <h1 className="Tabletspage_message">All accessories run out</h1>
          )}
      </div>
    </div>
  );

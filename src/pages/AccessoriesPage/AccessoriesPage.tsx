...
export const AccessoriesPage: React.FC = () => {
  ...
  const filteredProducts = filterProducts(products, Categories.Accessories);
  ...
  return (
    <div className="accessoriesPage" id="accessories">
      ...
      <div className="accessoriesPage__title">
        <h1 className="accessoriesPage__title_text">Accessories</h1>
        <p className="accessoriesPage__title_count">
          {filteredProducts.length} models
        </p>
      </div>

      <div className="accessoriesPage__dropdown_section">
        <DropdownBlock />
      </div>

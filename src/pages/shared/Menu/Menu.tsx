        ...
        <div className="App_menu">
            <nav className="menu">
                <div className="menu_list">
                    ...
                    <Link to="/phones" className="menu_link">Phones</Link>
                    <Link to="/tablets" className="menu_link">Tablets</Link>
                    <Link to="/accessories" className="menu_link">Accessories</Link>
                </div>
            </nav>

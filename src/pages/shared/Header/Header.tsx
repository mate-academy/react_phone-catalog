                    ...
                    <div className="header_list">
                        {!isMobile && (
                            <>
                                ...
                                <Link to="phones"  className='header_item'>Phones</Link>
                                <Link to="tablets"  className='header_item'>Tablets</Link>
                                <Link to="accessories"  className='header_item'>Accessories</Link>
                                </>
                        )}
                ...
                <div className="header_buttons-right">
                    {isMobile && (
                        <div className="header_icon header_icon-menu" onClick={() => setMenuBtn(prev => !prev)}>
                            <img src={menuBtn ? "img/Close.svg" : "img/Menu.svg"}
                                alt="Menu icon"
                                className="icon" />
                        </div>
                    )}

...
export const typographyStyle = {
  h1: 'font-Mont text-[32px] font-bold leading-[41px] tracking-[-0.01em]',
  h2: 'font-Mont text-[22px] font-bold leading-[31px] tracking-[0]',
  h3: 'font-Mont text-[20px] font-semibold leading-[26px] tracking-[0]',
  uppercase:

      ...
      <section className={style.description}>
        <div className={style.description__product}>
          ...
          {description.map((item: DescriptionItem, index: number) => (
            <div key={index}>
              <h2 key={index} className={style.description__product__title}>{item.title}</h2>
              {item.text.map((paragraph, pIndex) => (
                <p
                  key={pIndex}
                  className={style.description__product__text}
                >
                  {paragraph}
                </p>
              ))}
        ...
        <div className={style.description__info}>
          ...
          <div className={style.product__cart__description}>
            <p className={style.description__info__parametr}>
              Screen
            </p>
            <p className={style.description__info__number}>
              {productScreen}
            </p>
          </div>
          <div className={style.product__cart__description}>

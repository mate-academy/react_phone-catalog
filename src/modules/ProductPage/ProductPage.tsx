...
//         const filteredProducts = data.filter((prod: Product) => prod.category === "phones");
...
//   const paginatedPhones = sortedPhones.slice((currentPage - 1) * itemsPerPage, currentPage * itemsPerPage);
...
//         </div>
//       )}
//       {!loader && !error && phones.length === 0 && <div>There are no phones yet.</div>}

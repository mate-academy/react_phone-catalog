...
import bannerBig from '../../../images/banners/banner-big.png';
import bannerSmall from '../../../images/banners/banner-small.png';
        ...
        {banners.map((banner, index) => (
          <SwiperSlide key={index}>
            <div>
              <button
                type="button"
                className={`${styles.button_prev} bannerPrev`}
              ></button>
              <button
                type="button"
                className={`${styles.button_next} bannerNext`}
              ></button>
              <img
                src={bannerImage}
                alt="Banner"

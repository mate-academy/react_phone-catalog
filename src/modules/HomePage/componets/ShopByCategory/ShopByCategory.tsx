...
export const ShopByCategory = () => {
  return (
    <div className={styles.categories}>
      ...
      <div className={styles.categories_wrapper}></div>
      <NavLink to="./phones" className={styles.categories_photo_container}>
        <img src={phones} alt="phones" className={styles.categories_photo} />
      </NavLink>
      <h4>Mobile phones</h4>
      <p>95 models</p>
      <NavLink to="./tablets" className={styles.categories_photo_container}>
        <img src={tablets} alt="tablets" className={styles.categories_photo} />
      </NavLink>
      <h4>Tablets</h4>
      <p>24 models</p>
      <NavLink to="./accessories" className={styles.categories_photo_container}>
        <img
          src={accessories}
          alt="accessories"

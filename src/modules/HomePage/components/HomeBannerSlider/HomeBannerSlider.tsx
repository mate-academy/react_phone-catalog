  ...
  return (
    ...
    >
      <div className={styles.homeBannerSlider__wrapper}>
        <button
          type="button"
          className={cn(styles.homeBannerSlider__arrow, styles.homeBannerSlider__arrowPrev)}
          onClick={prev}
                      ...
                      <div className={styles.homeBannerSlider__bannerTop}>
                        {banner.kicker && (
                          <p className={styles.homeBannerSlider__bannerKicker}>
                            <span className={styles.homeBannerSlider__bannerKickerText}>
                              {banner.kicker}
                            </span>
                            {banner.icon && (
                              <img
                                ...
                                alt=""
                                aria-hidden="true"
                                className={styles.homeBannerSlider__bannerKickerIcon}
                              />
                            )}
                          </p>
                        )}
                        ...
                        {banner.text && (
                          <p className={styles.homeBannerSlider__bannerText}>{banner.text}</p>
                        )}
                      </div>

                      <Link to={banner.link} className={styles.homeBannerSlider__bannerButton}>
                        {banner.cta}
                      </Link>
                    </div>
                    ...
                    <div className={styles.homeBannerSlider__bannerImageWrap}>
                      {banner.kicker && (
                        <p className={styles.homeBannerSlider__imageKicker}>
                          <span className={styles.homeBannerSlider__imageKickerText}>
                            {banner.kicker}
                          </span>
                        </p>
                      )}
        ...
        <button
          type="button"
          className={cn(styles.homeBannerSlider__arrow, styles.homeBannerSlider__arrowNext)}
          onClick={next}
      ...
      <div className={styles.homeBannerSlider__dotsWrap}>
        <div className={styles.homeBannerSlider__dots} role="tablist" aria-label="Select banner">
          {BANNERS.map((_, idx) => (
            <button
              key={idx}
              type="button"

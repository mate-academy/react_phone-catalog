    ...
    <section className="xl:px-[152px] lg:px-8 sm:px-6 px-4 mt-20 font-mont">
      ...
      <div className="flex flex-col items-center sm:flex-row sm:gap-4">
        <div className="mt-6">
          ...
          <div className="pt-6">
            <h3 className="font-bold text-text-color-base-white">
              Mobile phones
            </h3>
            <p className="font-semibold text-sm leading-[21px] text-text-color-base-grey">
              95 models
            </p>
          </div>
        </div>

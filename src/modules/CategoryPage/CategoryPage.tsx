...
export const CategoryPage = () => {
  ...
  const productsFromServer = useAppSelector((state: { products: any; }) => state.products);
  ...
  return (
    <main>
      ...
      <div className="products">
        {productsToShow.map((product: Product, index: React.Key | null | undefined) => (
      ...
      {showPagination && (
        <div className="pagination">
          <Link
            ...
            className={classNames('pagination__item pagination__arrow-fon', {

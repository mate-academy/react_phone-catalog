    ...
    <div className={styles.categoryPage}>
      ...
      {isLoading ? (
        ...
        <>
          ...
          <p className={styles.categoryPage__modelsAmount}>
            {productAmount} models
          </p>
          ...
          <div className={styles.categoryPage__filters}>
            <div className={styles.categoryPage__filters_sort}>
              ...
              >
                <button
                  ...
                  onClick={() =>
                    setIsDropdownOpen(p => ({ ...p, sort: !p.sort }))
                  }
                >
            ...
            <div className={styles.categoryPage__filters_perPage}>
              <p className={styles.categoryPage__filters_name}>
                Items on page:
              </p>
              <div
                className={styles.dropdown}
              ...
              >
                <button
                  className={`${styles.dropdown__button}`}
                  onClick={() =>
                    setIsDropdownOpen(p => ({ ...p, perPage: !p.perPage }))
                  }
                >
                  {perPage || 'All'}
                  <span
          ...
          <ProductsList
            ...
            itemsPerPage={perPage ? +perPage : productAmount}
          />
        </>
      )}
    </div>

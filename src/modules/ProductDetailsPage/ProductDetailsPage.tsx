...
import { Category, ProductDetails } from '@/shared/type';
...
export const ProductDetailsPage = ({ category }: { category: Category }) => {
  ...
  }, [productId, navigate, category]);

  const productDetails = (product: ProductDetails, productByNamespace: ProductDetails[]) => {
    return (
      <main>
        <article className={styles.container}>
          <h1 className={styles.title}>{product.name}</h1>
          <ImageSwiper className={styles.imageSwiper} images={product.images}></ImageSwiper>
          <div className={styles.parameters}>
            <div className={styles.parameterBox}>
              <div className={styles.parameterTitle}>
                <p>Available colors</p>
                <p>{`ID ${hashString(product.id)}`}</p>
              </div>
            ...
            <div className={styles.priceBox}>
              <h3 className={styles.price}>{'$' + product.priceDiscount}</h3>
            ...
            <div className={classNames(styles.details, styles.detailsMarginTop32)}>
              <div className={styles.detail}>
                ...
                <p className={classNames(styles.detailText2, styles.detailText2fontWeight700)}>
                  {product.screen}
                </p>
              </div>
              <div className={styles.detail}>
              ...
              <div className={styles.detail}>
                <p className={styles.detailText1}>{t('productCart.processor')}</p>
                <p className={classNames(styles.detailText2, styles.detailText2fontWeight700)}>
                  {product.processor}
                </p>
              </div>
          ...
          <div className={styles.sections}>
            <section className={styles.sectionAbout} aria-label="About product">
              ...
              <div
                className={classNames(
                  styles.line,
                  styles.lineMarginBottom32,
                  styles.lineMarginTop24,
                )}
              ></div>
            ...
            <section className={styles.sectionTechSpecs} aria-label="About product">
              ...
              <div className={classNames(styles.details)}>
                <div className={styles.detail}>
                  <p className={classNames(styles.detailText1, styles.detailText1fontSize14)}>
                    {t('productCart.screen')}
                  </p>
                  <p className={classNames(styles.detailText2, styles.detailText2fontSize14)}>
                    {product.screen}
                  </p>
                </div>
  ...
  const productDetailsDefault = productDetails(
    {
  ...
  const stateSwitch = () => {
    switch (state.status) {
      case 'loading':
        return <Skeleton loading={true}>{productDetailsDefault}</Skeleton>;

      case 'error':
        return <p>{state.error}</p>;

      case 'success': {
        return productDetails(state.product.productDetail, state.product.productByNamespace);
      }
    }
  };
  ...
  return (
    <div>
      ...
      <div className={styles.content}> {stateSwitch()}</div>
    </div>
  );
};

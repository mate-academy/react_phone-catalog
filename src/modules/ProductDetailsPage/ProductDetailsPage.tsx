...
export const ProductDetailsPage: React.FC = () => {
  ...
  const inCart = isInCart(productFromList.itemId);
  const favorited = isFavorite(productFromList.itemId);
            ...
            <div className={styles.thumbnails}>
              {product.images.map((image, index) => (
                <button
                  ...
                  aria-label={`Photo ${index + 1} of ${product.name}`}
                ...
                return (
                  <label
                    ...
                    className={cn(styles.colorOption, {
                      [styles.colorOptionActive]: isSelected,
                    })}
                  ...
                  >
                    <input
                      ...
                      checked={isSelected}
                      onChange={() => navigate(buildLink(color))}
                    />
                    <span
                ...
                return (
                  <label
                    ...
                    className={cn(styles.capacityOption, {
                      [styles.capacityOptionActive]: isSelected,
                    })}
                  >
                    <input
                      type="radio"
                      ...
                      className={styles.radioHidden}
                      checked={isSelected}
                      onChange={() => navigate(buildLink(product.color, cap))}
                    />
                    {cap}
                  </label>
                );

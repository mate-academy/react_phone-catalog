...
// import * as Tooltip from '@radix-ui/react-tooltip/dist';
      ...
      <div className={style.container}>
          ...
          <div className={style.mainInfoSelectable}>
            ...
            <ul className={style.paramsList}>
              ...
              <li className={style.paramItem}>
                ...
                <span className={style.paramValue}>{currentProduct?.ram}</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className={style.column}>
          ...
          {currentProduct?.description.map(desc => (
            ...
            >
              <Heading as={'h4'}>{desc.title}</Heading>
              {desc.text.map((descText, idx) => (
                <span key={currentProduct?.id + idx}>{descText}</span>
              ))}
            </div>
          ))}
        </div>
        ...
        <div className={style.column}>
          ...
          <ul className={style.allParamsList}>
            <li className={style.paramItem}>
              <span className={style.paramType}>Screen</span>
              <span className={style.paramValue}>{currentProduct?.screen}</span>
            </li>
            <li className={style.paramItem}>
              <span className={style.paramType}>Resolution</span>
              <span className={style.paramValue}>
            ...
            <li className={style.paramItem}>
              ...
              <span className={style.paramValue}>{currentProduct?.camera}</span>
            </li>
            <li className={style.paramItem}>
              <span className={style.paramType}>Zoom</span>
              <span className={style.paramValue}>{currentProduct?.zoom}</span>
            </li>
            <li className={style.paramItem}>

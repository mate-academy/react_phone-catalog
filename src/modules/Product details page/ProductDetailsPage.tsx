  ...
  useEffect(() => {
    const imgs = product
      ? [...Array(product.images.length)].map((_, index) => {
          return `../../../public/img/${category}/${product.namespaceId}/${product.color}/0${index}.webp`;
        })
      : [];
                      ...
                      <img
                        src={
                          isFavourite(product.id)
                            ? '../../../../../public/img/buttons/Icons/Buttons/Icons/Favourites Filled (Heart Like).svg'
                            : '../../../public/img/Favourites (Heart Like).svg'
                        }
                        alt="like"

...
export const Tablets: React.FC = () => {
  ...
  const preparedProducts = useMemo(() => {
    ...
    return products;
  }, [sortSelectedValue, isPhones, isTablets, isAccessories]);
  ...
  return (
    <div className={styles.product_page}>
      <div className={styles.product_page__container}>
        <h1 className="hidden">Tablets page</h1>
        ...
        {isLoading ? (
          ...
          <div className={styles.error}>
            <p>{error}</p>
            <button onClick={fetchTablets}>Reload</button>
          </div>
        ) : tablets.length === 0 ? (
          <div className={styles.empty}>There are no tablets yet.</div>
        ) : (
          <>
            <div className={styles.breadcrumbs}>
              ...
              <h4 className={styles.breadcrumbs__current}>Tablets</h4>
            </div>

            <h1 className={styles.product_page__title}>Tablets</h1>
            <h4

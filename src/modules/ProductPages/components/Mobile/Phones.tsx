...
export const Phones: React.FC = () => {
  ...
  const preparedProducts = useMemo(() => {
    ...
    return products;
  }, [sortSelectedValue, isAccessories, isPhones, isTablets]);
  ...
  return (
    <div className={styles.product_page}>
      <div className={styles.product_page__container}>
        <h1 className="hidden">Phones page</h1>
        ...
        {isLoading ? (
          ...
          <div className={styles.error}>
            <p>{error}</p>
            <button onClick={fetchPhones}>Reload</button>
          </div>
        ) : phones.length === 0 ? (
          <div className={styles.empty}>There are no phones yet.</div>
        ) : (
          <>
            <div className={styles.breadcrumbs}>
              ...
              <h4 className={styles.breadcrumbs__current}>Phones</h4>
            </div>

            <h1 className={styles.product_page__title}>Mobile phones</h1>
            <h4

...
export const ProductCard = ({ product }: Props) => {
  ...
  return (
    <article className={styles['product-card']}>
      <Link to={`/product/${product.itemId}`} state={{ category: product.category }} className={styles['product-card__link']}>
        <img
          src={image}
          alt={name}
      ...
      <div className={styles['product-card__price']}>
        ...
        {fullPrice && (
          <div className={styles['product-card__price-regular']}>${fullPrice}</div>
        )}
      </div>
      ...
      <dl className={styles['product-card__info']}>
        ...
        <div className={styles['product-card__info-row']}>
          <dt className={styles['product-card__info-label']}>{t('productCard.screen')}</dt>
          <dd className={styles['product-card__info-value']}>{screen}</dd>
        </div>
        <div className={styles['product-card__info-row']}>
          <dt className={styles['product-card__info-label']}>{t('productCard.capacity')}</dt>
          <dd className={styles['product-card__info-value']}>{capacity}</dd>
        </div>
        <div className={styles['product-card__info-row']}>
          <dt className={styles['product-card__info-label']}>{t('productCard.ram')}</dt>

...
const links = [
  { name: 'Github', url: 'https://github.com/olhakostovetska' },
  { name: 'Contacts', url: 'https://www.instagram.com/kostovetskaolia/' },
  { name: 'Rights', url: 'https://github.com/olhakostovetska' },
];

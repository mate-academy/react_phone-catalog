...
export const MoveLeft: React.FC<Props> = React.memo(({ move, disabled }) => {
  return (
    <button
      type="button"
      onClick={move}
...
export const MoveRight: React.FC<Props> = React.memo(({ move, disabled }) => {
  return (
    <button
      type="button"
      onClick={move}
...
export const MoveNumber: React.FC<Props> = React.memo(
  ({ move, disabled, number }) => {
    return (
      <button
        type="button"
        onClick={move}

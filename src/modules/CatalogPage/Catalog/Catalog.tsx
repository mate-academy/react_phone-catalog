    ...
    <div className={style.catalog}>
      {itemsOnPage.map((phone: Phone) => (
        <article className={style.catalog__product} key={phone.id}>
          <Link to={`/${currentPage}/${phone.id}`} className={style.catalog__product__link}>
            <img
          ...
          <h4 className={style.catalog__product__price}>${phone.priceRegular}</h4>
          <hr className={style[`catalog__product--line`]} />

          <div className={style.catalog__product__description}>
            <p className={style.catalog__product__description__screen}>Screen</p>
            <p className={style[`catalog__product__description__screen--number`]}>
              {phone.screen}
            </p>
          </div>
          <div className={style.catalog__product__description}>
            <p className={style.catalog__product__description__capacity}>Capacity</p>
            <p className={style[`catalog__product__description__capacity--number`]}>
              {phone.capacity}
            </p>
          </div>
          <div className={style.catalog__product__description}>
            <p className={style.catalog__product__description__ram}>RAM</p>
            <p className={style[`catalog__product__description__ram--number`]}>
              {phone.ram}
            </p>
          </div>
          ...
          <div className={style.catalog__product__buttons}>
            ...
            <button className={style.catalog__product__buttons__button__favourites}>
              <span className={style[`catalog__product__buttons__button__favourites--heart`]}></span>
            </button>
          </div>
        </article>
      ))}

...
import { addCoundBacketId, deleteBacketId, subtractionCoundBacketId } from "../../../../features/basketSlice";
import { useAppDispatch } from "../../../../hooks/hookStore";
import { ProductType } from "../../../../types/productsType";
import { CLOSING_SVG, MINUS_SVG, PLUS_SVG } from "../../../../utils/SVG";
import { CartCardStyled, CountCalcStyled, InfoImgStyled, InfoSecondStyled, InfoStyled, PriceItemStyled } from "./styled";

...
const BANNERS = [
  {
    desktop: 'banners/iphone_banner.png',
    mobile: 'banners/iphone_banner_mobile.png',
    link: 'product/apple-iphone-14-pro-512gb-spaceblack',
  },
  // {
  //   desktop: 'banners/watch_banner1.png',
  //   mobile: 'banners/watch_banner1.png',
  //   link: 'product/apple-watch-series-6-44mm-space-gray',
  // },
  // {
  //   desktop: 'banners/ipad_banner1.png',
  //   mobile: 'banners/ipad_banner1.png',

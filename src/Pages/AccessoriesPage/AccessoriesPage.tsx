...
export const AccessoriesPage: React.FC = () => {
  ...
  const visibleTablets = sortedAccessories.slice(startItem - 1, endItem);
    ...
    <div className="container accessories">
      <div className="home">
        ...
        <img
          ...
          alt="right"
        />
        <p className="home__text">Accessories</p>
      </div>
      ...
      {visibleTablets.length === 0 ? (
        ...
        <>
          ...
          <p className="models">{`${accessories.length} models`}</p>
          ...
          <div className="tablets__selectors">
            <div className="selector">
              ...
              >
                ...
                <option className="selector__option" value="price">
                  Cheapest
                </option>
              </select>
            </div>

                  ...
                  <div className="products-slider__item-buttons">
                    <button
                      className={classNames('products-slider__item-button products-slider__item-button-cart', {
                        'products-slider__item-button-cart--active': localStorage.getItem('carts')?.includes(device.id),
                      })}
                      type="button"
                      onClick={() => {
                        let carts = [];
                        ...
                        if (!carts.find((p: CartItem) => p.id === device.id)) {
                          localStorage.setItem('carts', JSON.stringify([
                            ...carts,
                            {
                              id: device.id,
                              count: 1,
                              price: device.newPrice,
                            },
                          ]));
                        } else {
                          localStorage.setItem('carts', JSON.stringify([
                            ...carts.filter((p: CartItem) => p.id !== device.id),
                          ]));
                        }
                    ...
                    <button
                      className={classNames('products-slider__item-button products-slider__item-button-favorite', {
                        'products-slider__item-button-favorite--active': localStorage.getItem('favorites')?.includes(device.id),
                      })}
                      type="button"
                      onClick={() => {
                        let favorites = [];
                        ...
                        if (!favorites.includes(device.id)) {
                          ...
                          localStorage.setItem('favorites', JSON.stringify([
                            ...favorites.filter((p: string) => p !== device.id),
                          ]));
                        }

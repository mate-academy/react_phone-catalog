  ...
  <div className="App">
      ...
      <div className="header__wrap">
        <div className="header__logo">
          <a href="#" className="header__logo-link">
            <img src="/img/logo.svg" alt="Nice Gadgets" className="header__logo-image" />
          </a>
        </div>
        <nav className="header__nav">
          <ul className="header__nav-list">
            ...
            <li className="header__nav-item">
              <a href="#" className="header__nav-link">Phones</a>
            </li>
            <li className="header__nav-item">
              <a href="#" className="header__nav-link">tablets</a>
            </li>
            <li className="header__nav-item">
              <a href="#" className="header__nav-link">accessories</a>
            </li>
          </ul>
        </nav>
      </div>
      ...
      <nav className="menu__nav">
        <ul className="menu__nav-list">
          ...
          <li className="menu__nav-item">
            <a href="#" className="menu__nav-link">Phones</a>
          </li>
          <li className="menu__nav-item">
            <a href="#" className="menu__nav-link">Tablets</a>
          </li>
          <li className="menu__nav-item">
            <a href="#" className="menu__nav-link">Accessories</a>
          </li>
        </ul>
      </nav>
    ...
    <main className="main page__main">
          ...
          <div className="picturesSlider">
            <div className="picturesSlider__container">
              <div className="picturesSlider__button">
                <img src="img/icons/arrow-left.svg" alt="Arrow left icon" className="icon" />
              </div>
                ...
                <div className="picturesSlider__aside">
                  <div>
                    <div>
                      ...
                      <span className="picturesSlider__aside-title">in our store!<img src="img/icons/ok-hand.svg" alt="Ok icon" className="picturesSlider__aside-ok" /></span>
                    </div>
                    <div className="picturesSlider__aside-description">Be the first!</div>
                  </div>
                  <a className="picturesSlider__aside-action" href="#/phones/apple-iphone-14-128gb-purple">Order now</a>
                </div>
                <div className="picturesSlider__container-image">
                  <img src="img/phones/apple-iphone-14/midnight/00.webp" alt="Slide" className="picturesSlider__image" />
                  <img src="img/phones/apple-iphone-14/purple/00.webp" alt="Slide" className="picturesSlider__image picturesSlider__image--active" />
                  <img src="img/phones/apple-iphone-14/yellow/00.webp" alt="Slide" className="picturesSlider__image" />
                </div>
              </div>
              <div className="picturesSlider__button">
                <img src="/img/icons/arrow-right.svg" alt="Arrow right icon" className="icon" />
              </div>
            </div>
      ...
      <section className="product-slider">
        <div className="product-slider__header">
          ...
          <div className="product-slider__controls">
            <button className="button-icon" aria-label="Назад"><span className="icon icon__arrow-left" /></button>
            <button className="button-icon" aria-label="Вперед"><span className="icon icon__arrow-right" /></button>
          </div>
        </div>
          ...
          <div className="product-slider__list">
            <article className="product-card">
              <a href="#" className="product-card__link">
                <img src="/img/phones/apple-iphone-14/purple/00.webp" alt="Apple iPhone 14 Pro 128GB Silver (MQ023)" className="product-card__image" />
                <h2 className="product-card__title">Apple iPhone 14 Pro 128GB Silver (MQ023)</h2>
              </a>
              ...
              <div className="product-card__actions">
                <a type="button" className="button button--selected button--full-width" href='#'>Added</a>
                <button type="button" className="button-icon button-icon--size-large button-icon--red" aria-label="Add to favorites">
                  <span className="icon icon__like" />
                </button>
              </div>
            </article>
            ...
            <article className="product-card">
              ...
              <div className="product-card__actions">
                <button type="button" className="button button--full-width">Add to cart</button>
                <button type="button" className="button-icon button-icon--size-large" aria-label="Add to favorites">
                  <span className="icon icon__like" />
                </button>
              </div>
            </article>
      ...
      <section className="shop-by-category">
        <h2 className="shop-by-category__header section__title">Shop by category</h2>
        <div className="shop-by-category__list">
          <div className="shop-by-category__item ">
            <div className="shop-by-category__container shop-by-category__container--color-mobile">
              <a href="#" className="shop-by-category__link">
                <img src="/img/category-phones.webp" alt="" className="shop-by-category__item-image" />
              </a>
            </div>
          ...
          <div className="shop-by-category__item ">
            <div className="shop-by-category__container shop-by-category__container--color-tablet">
              <a href="#" className="shop-by-category__link">
                <img src="/img/category-tablets.webp" alt="" className="shop-by-category__item-image" />
              </a>
            </div>
            <div className="shop_by_category__footer">
          ...
          <div className="shop-by-category__item ">
            <div className="shop-by-category__container shop-by-category__container--color-accessories">
              <a href="#" className="shop-by-category__link">
                <img src="/img/category-accessories.webp" alt="" className="shop-by-category__item-image" />
              </a>
            </div>
      ...
      <section className="new-models">
        <div className="product-slider">
          <div className="product-slider__header">
            <h2 className="product-slider__title section__title">Brand new models</h2>
            <div className="product-slider__controls">
              <button className="button-icon" aria-label="Назад"><span className="icon icon__arrow-left" /></button>
              <button className="button-icon" aria-label="Вперед"><span className="icon icon__arrow-right" /></button>
            </div>
          ...
          <div className="product-slider__wrapper">
            <div className="product-slider__list">
              <article className="product-card product-card--in-slider">
                ...
                <div className="product-card__actions">
                  <a type="button" className="button button--full-width" href='#'>Add to cart</a>
                  <button type="button" className="button-icon button-icon--size-large" aria-label="Add to favorites">
                    <span className="icon icon__like" />
                  </button>
                </div>
    ...
    <footer className="footer">
      <div className="footer__content">
        ...
        <div className="footer__section footer__section--back">
          <a href="#top" className="footer__back-link">Back to top</a>
          <button className="footer__back-button button-icon" aria-label="Back to top">

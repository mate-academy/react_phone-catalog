...
export const ProductCard: React.FC<Props> = ({ product }) => {
  ...
  const productParamChange = (productId: string) => {
    ...
    setSearchParams(updateSeachParams(searchParams, { productParam: productId || null }));
  };

  return (
    <div className="productCard">
      <img src={`_new/${image}`} className="productCard__img" alt="Phone Image" />
      <div className="productCard__info">
        ...
        >
          <p className="productCard__name" onClick={() => productParamChange(phoneId)}>
            {name}
          </p>
        </Link>

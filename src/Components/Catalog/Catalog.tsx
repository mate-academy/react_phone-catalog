...
export const Catalog: React.FC<Props> = ({
  ...
  const productsPerPage = [...visibleProducts].slice(productStat - 1, productEnd);
      ...
      <form method="post" className="catalog__form">
        <div className="catalog__form-wrapper">
          <label htmlFor="perPage" className="catalog__form-item">
            ...
            <select name="itemsPerPage" id="perPage" className="catalog__form-select" value={perPage} onChange={(event) => onPerPageChange(event)}>
          ...
          <label htmlFor="perPage" className="catalog__form-item">
            ...
            <select name="itemsPerPage" id="perPage" className="catalog__form-select" value={sortBy} onChange={onSortByChange}>

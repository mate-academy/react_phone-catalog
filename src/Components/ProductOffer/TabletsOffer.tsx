...
export const TabletsOffer = () => {
  ...
  return (
    <>
      <Nav />
      <div
        className={classNames([tabletOffer.backgroundLoader], {
          [tabletOffer.backgroundLoaderOFF]: !loading,
        })}
      ...
      >
        <ReactLoading
          ...
          type="spokes"
          data-theme={themeSwitcher ? 'dark' : 'light'}
          className={tabletOffer.loader}
        />
      </div>
      <div
        className={classNames([tabletOffer.offer], {
          [tabletOffer.offerOFF]: loading,
        })}
      >
        {!error ? (
          <div
            className={tabletOffer.productoffer}
            data-theme={themeSwitcher ? 'dark' : 'light'}
          >
            <button
            ...
            <div className={tabletOffer.breadcrumbs}>
              <Link to="/">
                <div
                  className={classNames([tabletOffer.breadcrumbs__home], {
                    [tabletOffer.breadcrumbs__homeONDARK]: themeSwitcher,
                  })}
                />
              </Link>
              <div className={tabletOffer.breadcrumbs__arrow} />
              <Link
                className={tabletOffer.breadcrumbs__textactive}
                to="/tablets"
              >
                <div className={tabletOffer.breadcrumbs__text}>Tablets</div>
              </Link>
              <div className={tabletOffer.breadcrumbs__arrow} />
            ...
            <div className={tabletOffer.containerONTABLET}>
              ...
              <div className={tabletOffer.panel}>
                <div className={tabletOffer.panel__id_and_title}>
                  ...
                  <div
                    className={tabletOffer.panel__idnumber}
                  >{`ID: ${id}`}</div>
                </div>
                    ...
                    return (
                      <button
                        ...
                        className={classNames(
                          [tabletOffer.panel__colorselection],
                          {
                ...
                {selectedTablet?.capacityAvailable.map(capacity => {
                  ...
                  return (
                    <button
                      className={classNames(
                        [tabletOffer.panel__capacity_option],
                        {
                  ...
                  {selectedProduct && (
                    <button
                      ...
                      className={classNames([tabletOffer.panel__heartbutton], {
                        [tabletOffer.panel__heartbuttonisactive]:
                          favouriteItems.find(item => item.itemId === itemId),
                        [tabletOffer.panel__heartbuttonONDARK]: themeSwitcher,
                        [tabletOffer.panel__heartbuttonONDARKISACTIVE]:
                          themeSwitcher &&
                          favouriteItems.find(item => item.itemId === itemId),
                      })}
                    ></button>
            ...
            <div className={tabletOffer.decription}>
              ...
              {selectedTablet?.description.map(data => (
                <>
                  <div className={tabletOffer.description__title}>
                    {data.title}
                  </div>
                  <div className={tabletOffer.description__text}>
                    {data.text}
                  </div>
                </>
              ))}
            ...
            <div className={tabletOffer.techspecs}>
              ...
              <div className={tabletOffer.techspec__data}>
                <div className={tabletOffer.techspec__title}>
                  Built in memory
                </div>
                <div className={tabletOffer.techspec__text}>
                  {selectedTablet?.capacity}

...
//   const compareProductIds = (a: Product, b: Product) => {
//     const isIPhone11A = a.name.includes('iPhone 11');
//     const isIPhone11B = b.name.includes('iPhone 11');
...
//     (_, index) => index + 1,
//   );
//   const showPreviousButton = currentPage > 1 && selectedCount !== 'ALL';
//   const showNextButton = currentPage < totalPages && selectedCount !== 'ALL';
...
//       <div className="container-for-PhoneOsm-title">
//         <h1 className="PhonesPageOsmTitle">Mobile phones</h1>
//         <p className="PhonesPageOsmText">71 models</p>
//       </div>
...
//               onClick={() => handlePageChange(pageNumber)}
//               style={currentPage === pageNumber ? { borderRadius: '1px' } : {}}
//             >
//               {pageNumber}
//             </button>
//           ))}

  ...
  return (
    ...
    >
      <div className="filter__nav">
        ...
        <p className="filter__nav-phone-title filter__nav-item">
          {selectedIphone?.name}
        </p>
      </div>
      <NavLink
      ...
      <article className="item__recommends">
        ...
        <div className="item__recommends-container">
          {iphoneRecommend.slice(0, 4).map((iphone) => {
            return (
              <div className="item__recommends-phone">
                <ShopCard
                  iphone={iphone}

...
import { setCurrentPage, setItemsPerPage } from '../../features/getProductsSlice';
...
export const GeneralProductsPage = () => {
  ...
  const sortedProducts = useMemo(() => {
    switch (selectedOrder) {
      ...
      case 'Alphabetically':
        return [...specificProducts].sort((a, b) => a.name.localeCompare(b.name));
      default:
  ...
  return (
    <div className={styles.phonesPage}>
      ...
      <div>
        <h1 className={styles.phonesPage_title}>
          {ucFirst(category)}
        </h1>
      ...
      <div className={styles.phonesPage_filters}>
        ...
        <div className={styles.phonesPage_filters_dropdown}>
          ...
          <div className={styles.phonesPage_filters_dropdown_dropdownContent}>
            <a onClick={() => handleItemsPerPageChange(String(specificProducts.length))}>
              <p>All</p>
            </a>

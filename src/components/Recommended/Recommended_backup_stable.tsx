            ...
            >
              ...
              <div className="rec__specs">
                <div className="rec__specs-spec">
                  {`${t('specs.screen')}`}<div className="rec__specs-value">{item.screen}</div>
                </div>
                <div className="rec__specs-spec">
                  {`${t('specs.capacity')}`}<div className="rec__specs-value">{item.capacity.replace('GB', ' GB')}</div>
                </div>
                <div className="rec__specs-spec">
                  {`${t('specs.ram')}`}<div className="rec__specs-value">{item.ram.replace('GB', ' GB')}</div>
                </div>
              </div>

...
export const Categories = React.memo(() => {
  ...
  const tabletCount = products.filter(item => item.type === 'tablet').length;

  const accessoriesCount = products
    .filter(item => item.type === 'accessories').length;

  return (
    <div className="container grid categories" data-cy="categoryLinksContainer">
      <h1 className="categories__title grid__item--1-7">Shop by category</h1>

      <Link
        to="phones"
        className="categories__category
        categories__category--1 grid__item--1-8"
      >
      ...
      <Link
        to="tablets"
        className="categories__category
        categories__category--2 grid__item--9-16"
      >
      ...
      <Link
        to="accessories"
        className="categories__category categories__category--3
        grid__item--17-24"
      >
        <img

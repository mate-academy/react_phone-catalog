    ...
    <div className="categories">
      ...
      <ul className="categories__list">
        <li className="categories__item">
          <NavLink to="/phones">
            <img src="../../img/images/home/phones.png" alt="" className="categories__img"/>
        ...
        <li className="categories__item">
          <NavLink to="/tablets/">
            <img src="../../img/images/home/tablets.png" alt="" className="categories__img"/>
        ...
        <li className="categories__item">
          <NavLink to="/accessories/">
            <img src="../../img/images/home/accesories.png" alt="" className="categories__img"/>

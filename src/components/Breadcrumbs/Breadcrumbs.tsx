  ...
  return (
    <div className={styles.breadcrumbs}>
      {crumbs.map((crumb, index) => (
        <div className={styles.crumbContainer} key={`${crumb.to}-${index}`}>
          <div
            className={`${styles.crumb} ${crumb.isLast ? styles.active : ''}`}
          >
            {crumb.isHome ? (
              <TransitionLink to={crumb.to} className={styles.linkHome}>
                <svg
              ...
              <TransitionLink to={crumb.to} className={styles.link}>
                {crumb.label}
              </TransitionLink>
            )}
          </div>

  ...
  return (
    <>
      ...
      <div className="breadcrumbs">
        ...
        <NavLink to={`/${category.toLowerCase()}`} className="breadcrumbs__name"
        ...
        {productId && productName && (
          <>
            <p className="breadcrumbs--arrow">&gt;</p>
            <p className="breadcrumbs__name">{productName}</p>
          </>
        )}
      </div>
      {productId && productName && (
        <div className='breadcrumbs__back'>
          <NavLink to={`/${category.toLowerCase()}`} className="breadcrumbs__back__arrow"
          >
            &lt;
          </NavLink>
          <NavLink to={`/${category.toLowerCase()}`} className="breadcrumbs__back__text"
          >
            Back
          </NavLink>
        </div>

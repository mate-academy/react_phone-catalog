...
export const DropDown: React.FC<Props> = ({ type }) => {
  ...
  const selectorList =
    type === 'sort-by' ? Object.keys(sortByList) : Object.keys(itemsOnPageList);
    ...
    <div className="DropDown">
      ...
      >
        <span className="DropDown__value">
          {type === 'items-on-page' ? itemsOnPage : sort}
        </span>
        <div>
          <img
            src={ArrowDown}
            alt="arrow down"
            className={classNames('DropDown__caret', {
          ...
          {selectorList.map((option, index) => (
            <li
              ...
              className={classNames('DropDown__option', {
                ...
                DropDown__option__highlighted: index === highlightedIndex,
              })}
            >
              <option

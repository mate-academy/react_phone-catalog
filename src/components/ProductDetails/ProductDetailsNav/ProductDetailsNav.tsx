...
export const ProductDetailsNav: React.FC<Props> = ({ category, productId }) => {
  ...
  return (
    <>
      <div className="navigation">
        ...
        <Link
          className="navigation__link navigation__link--not_active"
          to={`/${category}`}
        >
          {category}
        </Link>
        ...
        <p className="navigation__link navigation__link--elips">{productId}</p>
      </div>

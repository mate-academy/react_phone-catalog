export const Card = ({ product }: { product: any }) => (
  <div className="card">
    <img src={product.images[0]} alt={product.name} className="card_image" />
    <h2>{product.name}</h2>
    ...
    <div className="card_buttons">
      <h3 className="card_buttons_add">Add to cart</h3>
      <div className="card_buttons_like">
        <svg
            width="16"
            height="14"
            viewBox="0 0 16 14"

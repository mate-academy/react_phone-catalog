...
import styles from './FavouritesIconWithCounter.module.scss';
...
const getLinkClass = ({ isActive }: { isActive: boolean }) =>
  cn(styles.navbar__favourites, {
    [styles.navbar__favourites_active]: isActive,
  });

...
export const Header = () => {
  ...
  return (
    <header className={s.header} id="header">
      <NavLink to="/" className={s.header__logo} onClick={()=> setMenuIsOpen(false)}>
        <picture>
      ...
      <div className={`${s.header__menu} ${menuIsOpen ? `${s['header__menu--active']}`: ''}`}>
        <Navigation setMenuIsOpen={setMenuIsOpen} />
        <Action setMenuIsOpen={setMenuIsOpen} />
      </div>

      <aside className={`${s.header__aside} ${menuIsOpen ? s['header__aside--open'] : ''} `}>  
        <div className={s['header__inner-header']}>
          <NavLink to="/" className={s.header__logo} onClick={()=> setMenuIsOpen(false)}>
            <img className= {s.header__icon} src ='/img/icons/Logo-mob.svg' alt='logo'/>
          </NavLink>

          <button
            className={s['header__burger-btn']} onClick={()=>setMenuIsOpen(false)}
          >

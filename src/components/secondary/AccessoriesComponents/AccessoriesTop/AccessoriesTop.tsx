...
export const AccessoriesTop: React.FC<Props> = ({
  accessoriesList,
  itemsPerPage,
  sortSelect,
}) => {
  ...
  return (
    <section className="accessories-top">
      <nav>
        <ul className="accessories-top__breadcrumb">
          ...
          <Link to="/accessories" className="accessories-top__breadcrumb-path">
            Accessories
          </Link>
        </ul>
      </nav>

      <h1 className="accessories-top__h1">Mobile accessories</h1>

      <p className="accessories-top__p">{accessoriesList?.length} models</p>

      <div className="accessories-top__selects">
        <div className="accessories-top__selects-sort">
          <p className="accessories-top__selects-sort-p">Sort by</p>
        ...
        <div className="accessories-top__selects-quantity ">
          <p className="accessories-top__selects-quantity-p">Items on page</p>

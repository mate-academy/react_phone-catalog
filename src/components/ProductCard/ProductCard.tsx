      ...
      <div className="product-card__bottom">
        ...
        <div className="product-card-details">
          <div className="product-card-details-option">
            <p className="product-card-details-option-title">Screen</p>
          ...
          <div className="product-card-details-option">
            <p className="product-card-details-option-title">Capacity</p>
            <p className="product-card-details-option-value">
              {product.capacity}
            </p>
          </div>
          ...
          <div className="product-card-details-option">
            <p className="product-card-details-option-title">RAM</p>

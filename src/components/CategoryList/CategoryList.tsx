...
export const CategoryList = () => {
  ...
  return (
    <div className="CategoryList">
      ...
      <div className="CategoryList__links" data-cy="categoryLinksContainer">
        <CategoryLink type="phones" amount={phonesAmount} />
        <CategoryLink type="tablets" amount={tabletsAmount} />
        <CategoryLink type="accessories" amount={accessoriesAmount} />
      </div>
    </div>
  );
};

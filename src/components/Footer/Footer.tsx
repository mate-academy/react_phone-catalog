...
export const Footer = () => {
  ...
  const openModal = (
    e: React.MouseEvent<HTMLAnchorElement | HTMLButtonElement, MouseEvent>, // Розбито на новий рядок
  ) => {
    e.preventDefault();
    setIsOpen(true);
  };
  ...
  return (
    <footer className="footer">
      ...
      <nav className="footer__nav nav">
        ...
        {/* Виправлено форматування - атрибути в одному рядку */}
        <a href="#" className="footer__nav-link nav__link" onClick={openModal}>
          Contacts
        </a>

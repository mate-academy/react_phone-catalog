          ...
          listPages.map(num => (
            ...
            >
              <Link
                className="pagination__page-link"
                to={{
                  search: getSearchWith({ page: num }, searchParams).toString(),
                }}
          ...
          <>
            ...
            >
              <Link
                className="pagination__page-link"
                to={{
                  search: getSearchWith({ page: 1 }, searchParams).toString(),
                }}
            ...
            >
              <Link
                ...
                to={{
                  search: getSearchWith(
                    {
                      page: currentPage - 3 <= 0 ? 1 : currentPage - 3,
                    },
                    searchParams,
                  ).toString(),
                }}

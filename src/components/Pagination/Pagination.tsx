...
function showVisiblePages(selectedPage: number, allPages: number) {
  ...
  const firstPage = selectedPage - (visiblePages - allPages);
  ...
  if (visiblePages > allPages) {
    for (let i = firstPage; i <= allPages; i += 1) {
      pages.push(i);
    }
  } else {
    ...
    <div className="pagination">
      <ul className="pagination_list">
        ...
        <li className="page-item page-item--hide">
          ...
          >
            {isLastPage ? (
              <img src={ICONS.arrowRightDisabled} alt="Scroll right" />
            ) : (
              <img src={ICONS.arrowRight} alt="Scroll right" />
            )}
          </Link>
        </li>
      </ul>

      ...
      {products.length > 4 && (
        <div className="pagination__choose">
          <div className="pagination__choose__block">
            ...
            >
              <div
                className="pagination__choose__dropdown__block"
                role="button"
                tabIndex={0}
                aria-label="arrow-down"
                onClick={() => setIsSortByOpen(!isSortByOpen)}
                onKeyDown={() => setIsSortByOpen(!isSortByOpen)}
              >
              ...
              <div className={
                cn(
                  'pagination__choose__dropdown__items',
          ...
          <div className="pagination__choose__block" data-cy="paginationRight">
            <div className="pagination__choose__title">
              Items Per Page
            </div>
            <div className="pagination__choose__dropdown">
              <div
                ...
                onKeyDown={() => setIsItemsPerPageOpen(!isItemsPerPageOpen)}
              >
                <div className="pagination__choose__dropdown__title">
              ...
              >
                <div
                  ...
                  aria-label="4"
                  className="pagination__choose__dropdown__item"
                  onClick={() => handleItemPerPageChange(
                    4,
                    setIsItemsPerPageOpen,
                  )}
                  onKeyDown={() => handleItemPerPageChange(
                    4,
                    setIsItemsPerPageOpen,
                  )}
                >
            ...
            <button
              ...
              className={
                cn(
                  ...
                  'pagination__pageList__item pagination__pageList__item__button',
                  {
            ...
            {getNumbers(pages).map((number) => (
              <div
                ...
                className={cn('pagination__pageList__item', {
                  'pagination__pageList__item--active': number === currentPage,
                })}

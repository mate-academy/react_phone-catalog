          ...
          <section>
            ...
            <div className="specifications">
              <div className="specifications_details">
                ...
                <p>
os:
                  {currentPhone.android.os}
                </p>
                <p>
ui:
                  {currentPhone.android.ui}
                </p>
              </div>
              <div className="specifications_details">
                ...
                <p>
primary:
                  {currentPhone.camera.primary}
                </p>
                <p>
features:
                  {currentPhone.camera.features.join(', ')}
                </p>
              </div>
              <div className="specifications_details">
                ...
                <p>
standbyTime:
                  {currentPhone.battery.standbyTime}
                </p>
                <p>
talkTime:
                  {currentPhone.battery.talkTime}
                </p>
                <p>
type:
                  {currentPhone.battery.type}
                </p>
              </div>
              <div className="specifications_details">
                ...
                <p>
bluetooth:
                  {currentPhone.connectivity.bluetooth}
                </p>
                <p>
cell:
                  {currentPhone.connectivity.cell}
                </p>
                <p>
gps:
                  {currentPhone.connectivity.gps ? 'yes' : 'no'}
                </p>
                <p>
infrared:
                  {currentPhone.connectivity.infrared ? 'yes' : 'no'}
                </p>
                <p>
wifi:
                  {currentPhone.connectivity.wifi}
                </p>
              </div>
              <div className="specifications_details">
                ...
                <p>
screenResolution:
                  {currentPhone.display.screenResolution}
                </p>
                <p>
screenSize:
                  {currentPhone.display.screenSize}
                </p>
                <p>
touchScreen:
                  {currentPhone.display.touchScreen ? 'yes' : 'no'}
                </p>
              </div>
              <div className="specifications_details">
                ...
                <p>
accelerometer:
                  {currentPhone.hardware.accelerometer ? 'yes' : 'no'}
                </p>
                <p>
audioJack:
                  {currentPhone.hardware.audioJack}
                </p>
                <p>
cpu:
                  {currentPhone.hardware.cpu}
                </p>
                <p>
fmRadio:
                  {currentPhone.hardware.fmRadio ? 'yes' : 'no'}
                </p>
                <p>
physicalKeyboard:
                  {currentPhone.hardware.physicalKeyboard ? 'yes' : 'no'}
                </p>
                <p>
usb:
                  {currentPhone.hardware.usb}
                </p>
              </div>
              <div className="specifications_details">
                ...
                <p>
flash:
                  {currentPhone.storage.flash}
                  {' '}

                </p>
                <p>
ram:
                  {currentPhone.storage.ram}
                </p>
              </div>
              <div className="specifications_details">
                ...
                <p>
weight:
                  {currentPhone.sizeAndWeight.weight}
                </p>
              </div>
            </div>
          </section>

  ...
  return (
    <div className="swiperButtons">
      <button
        type="button"
        disabled={isBegin}
        className={classNames('swiperButtonsPrev', {
          'swiperButtonsPrev--disabled': isBegin,
        })}
        onClick={() => handleClickPrev()}
      >
        <img src={isBegin ? ArrowLeftDisabled : ArrowLeft} alt="arrow left" />
      </button>

      <button
        type="button"
        className={classNames('swiperButtonsNext', {
          'swiperButtonsNext--disabled': isEnd,
        })}
        disabled={isEnd}
        onClick={() => handleClickNext()}
      >
        <img src={isEnd ? ArrowRightDisabled : ArrowRight} alt="arrow right" />
      </button>
    </div>
  );
};

...
const ProductCard: React.FC<Props> = ({ product }) => {
  return (
    <Link to={`./${product.category}/${product.itemId}`}>
      <div className="lg:w-[272px] lg:h-[506px]  sm:w-[237px] sm:h-[512px] w-[212px] h-[439px] flex flex-col gap-2 font-mont p-8 text-center border   justify-between border-gray-200 ">
        <div className="w-[148px] h-[129px] sm:w-[173px] sm:h-[202px] lg:w-[208px] lg:h-[196px] p-0">
          <img
            className="p-0 w-full h-full hover:scale-[1.1] object-contain m-0"
            src={`../../../public/${product.image}`}
            alt=""
          />
        </div>
        <h1 className="text-sm text-gray-700 font-semibold text-left">
          {product.name}
        </h1>

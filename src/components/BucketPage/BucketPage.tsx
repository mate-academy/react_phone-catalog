...
import {
  ...
  decrementQuantity,
  removeBucket,
} from '../../features/addBucketInfoSlice';
                ...
                >
                  <div
                    className={
                      ...
                      styles.bucket__generalProducts_products_product_firstSection
                    }
                  >
                    <img
                      onClick={() => {
                    ...
                    <img
                      className={
                        // eslint-disable-next-line max-len
                        styles.bucket__generalProducts_products_product_firstSection_image
                      }
                      src={`${product.image}`}
                      alt="img"
                    />
                  ...
                  <div
                    className={
                      // eslint-disable-next-line max-len
                      styles.bucket__generalProducts_products_product_secondSection
                    }
                  >
                    <div
                      className={
                        // eslint-disable-next-line max-len
                        styles.bucket__generalProducts_products_product_secondSection_buttons
                      }
                    >
                      <div
                        className={

    ...
    <section className="shop_by_category">
      ...
      <div className="shop_by_category-div">
        <Link className="shop_by_category--link" to="/phones">
          ...
          <p className="shop_by_category__models-number">{`${getGoods('phones').length} models`}</p>
        </Link>
        ...
        <Link className="shop_by_category--link" to="/tablets">
          ...
          <p className="shop_by_category__models-number">{`${getGoods('tablets').length} models`}</p>
        </Link>
        ...
        <Link className="shop_by_category--link" to="/accessories">
          ...
          <p className="shop_by_category__models-number">{`${getGoods('accessories').length} models`}</p>
        </Link>
      </div>
    </section>
  );

        ...
        <div className="Details__card">
          ...
          <div className="Details__colors">
            ...
            <div className="Details__colors-link">
              {colors?.map(color => (
                <Link
                  to={
                    details ? pathname.replace(details.color, color) : pathname
                  }
                  key={color}
                >
                  <div
          ...
          <div className="Details__description">
            ...
            <div className="Details__description-item">
              ...
              <p className="Details__description-value">{details?.processor}</p>
            </div>
            <div className="Details__description-item">
        ...
        <section className="Spect">
          ...
          <article className="Spect__content">
            ...
            <div className="Spect__content-item">
              ...
              <p className="Spect__content-value">{details?.cell.join(', ')}</p>
            </div>
          </article>
        </section>
      </div>

      <Slider products={maxDiscountProducts} title="You may also like" />
    </div>
  );
};

...
export const PageNav = () => {
  ...
  return (<div className={styles.page}>
    ...
    <NavLink to={`/${currentLocation}`} className=
      {({ isActive }) => classNames(styles.page__text, { [styles['page__text--disabled']]: !productId })}>{locationName}</NavLink>
    {productId && <> <IoIosArrowForward className={styles.page__icon} />

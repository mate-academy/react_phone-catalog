    ...
    <>
      ...
      {cartItems.length === 0 ? (
        <div className="empty-cart">
          <img
            src={`${import.meta.env.BASE_URL}images/pages/cart-is-empty.png`}
            alt="Empty Cart"
                  ...
                  <div className="shopping-button-and-summa">
                    <div className="shopping-box-3-4">
                      <div className="shopping-button">
                        ...
                        >
                          <img
                            src={`${import.meta.env.BASE_URL}images/icons/Minus.svg`}
                        ...
                        >
                          <img
                            src={`${import.meta.env.BASE_URL}images/icons/Plus.svg`}
                            className="shopping-button-icon"
                            alt="Increase"
                          />
                        </button>

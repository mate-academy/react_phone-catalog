...
export default function NewModels({ products }) {
  ...
  return (
    <div className="swiper-wrapper-custom relative">
      <div className="swiper-button">
        <p className="swiper-wrapper-title">Brand new models</p>
        <div className="swiper-button-box">
          ...
          >
            <img
              src={`${import.meta.env.BASE_URL}images/icons/Chevron_Arrow_Left${
          ...
          >
            <img
              src={`${import.meta.env.BASE_URL}images/icons/Chevron_Arrow_Right${
                isEnd ? '_Disabled' : ''
              }.svg`}
              className="icons_arrow"
              alt="Chevron Right"

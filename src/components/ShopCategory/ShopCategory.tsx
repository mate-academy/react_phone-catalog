    ...
    <div className="shopCategory">
      <div className="container">
        ...
        <div className="shopCategory__block">
          ...
          >
            <img src="./react_phone-catalog/img/Categories/phones-cat.jpg" alt="" />
          ...
          <Link
            ...
            className="shopCategory__item"
          >
            <img src="./react_phone-catalog/img/Categories/tablets-cat.jpg" alt="" />
            <h3 className="shopCategory__name">
              Tablets
            </h3>
            <p className="shopCategory__count">
          ...
          <Link
            ...
            className="shopCategory__item"
          >
            <img src="./react_phone-catalog/img/Categories/accessories-cat.jpg" alt="" />
            <h3 className="shopCategory__name">
              Accessories
            </h3>
            <p className="shopCategory__count">

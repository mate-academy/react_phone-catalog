...
export const ProductDetailsInfo: FC<Props> = ({
  ...
  return (
    <div className="product-data">
      <div className="product-data__available-colors colors">
        ...
        <div className="colors__colors-icons">
          {colors.map(color => (
            <Link
              to={
                getLinkToProduct(category, nameId, currentCapacity, color)
              }
              key={color}
      ...
      <div className="product-data__capacity capacity">
        <p
          className="
          capacity__capacity-title
          info-block-title
        "
        >
          Select capacity

...
export const ProductsSlider: React.FC<Props> = ({ title, filter, sortBy }) => {
  const { cardWidth, cardGap } = sliderSettings;
    ...
    <div className="ProductsSlider">
      ...
      {!loading && (
        <div className="ProductsSlider__products-container">
          <div className="ProductsSlider__products" data-cy="cardsContainer">

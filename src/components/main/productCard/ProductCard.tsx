      ...
      {discount ? (
        <>
          <div className={styles['productCard__container']}>
            <span className={styles['productCard__container__price']}>${price}</span>
            <span className={styles['productCard__container__price__reduce']}>${fullPrice}</span>
          </div>
        </>
      ) : (
        <div className={styles['productCard__container']}>
            <span className={styles['productCard__container__price']}>${fullPrice}</span>

...
import SquareSelectLikeButton
  from '../../UI/buttons/SquareSelectButton/descendants/SquareSelectLikeButton';
...
import {
  RectangleTextItem,
} from '../../UI/OptionTogglerItems/RectangleTextItem/RectangleTextItem';

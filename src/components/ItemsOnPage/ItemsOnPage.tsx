...
export const ItemsOnPage: React.FC<Props> = ({
  ...
  return (
    <div className="itemsOnPage">
      <p className="itemsOnPage__title">Items on page</p>
      <div
        role="button"
        tabIndex={0}
      ...
      >
        ...
        <div>
          <img
            src={ArrowDown}
            alt="arrow down"
            className={classNames('itemsOnPage__caret', {
              'itemsOnPage__caret--up': isOpen,
            })}
          />
        </div>
        <ul
          className={classNames('itemsOnPage__options', {
        ...
        >
          {options.map((option, index) => (
            <li key={option.value}>
              <option
                className={classNames('itemsOnPage__option', {

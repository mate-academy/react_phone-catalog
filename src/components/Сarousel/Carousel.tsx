...
const Carousel = ({
            ...
            try {
                ...
                if (type === 'hot-prices') {
                    ...
                    data.forEach(product => {
                        ...
                        if (!uniqueModels.has(baseModelId) || product.capacity === '128GB') {
                    ...
                    filteredProducts = data
                        .filter(product => {
                            if (product.itemId === currentProductId) return false;
    ...
    return (
        <section className={styles['modelCatalog']}>
            ...
            <div
                className={styles['modelCatalog_carousel']}
                ref={carouselRef}
            >

      ...
      <div className="carousel__arrows">
        <button
          ...
          style={{
            ...
            backgroundImage: `url(react_phone-catalog/img/icons/icon-arrow${canScrollLeft ? '-active' : ''}.svg)`,
          }}
        ...
        <button
          ...
          style={{
            backgroundImage: `url(react_phone-catalog/img/icons/icon-arrow${canScrollRight ? '-active' : ''}.svg)`,

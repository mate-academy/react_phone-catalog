...
export const Catalog: React.FC<Props> = ({ items }) => {
  ...
  const sortedItems = sortItemsBy(items, sortBy);
      ...
      <div className="catalog__container">
        <div className="catalog__top">
          <div className="dropdown dropdown--sort" ref={dropdownSortRef}>
            <label htmlFor="dropdown-sort__trigger" className="dropdown__label">
              Sort by
            </label>
            <div
          ...
          <div className="dropdown dropdown--per-page" ref={dropdownPerPageRef}>
            <label

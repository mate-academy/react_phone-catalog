    ...
    <div className="flex ">
      ...
      >
        ...
        <div className="absolute bottom-0 left-0 right-0 flex border-[1px] border-[rgba(226,230,233,1)]">
          <Link to="favourites" className="shadow-el nav-icons--active flex w-[100%] justify-center py-[24px]">
          ...
          <Link to="cart" className="shadow-el nav-icons--active flex w-[100%] justify-center py-[24px]">
            <div>

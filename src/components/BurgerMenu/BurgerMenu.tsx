  ...
  return (
    <>
      {isActive ? (
        ...
        >
          <img src={CrossImg} alt="close burger menu" />
        </button>
      ) : (
        <button
      ...
      >
        <div className="burgerMenu__content">
            ...
            {navLinks.map(item => (
              <li className="burgerMenu__navItem" key={item.value}>
                <Link to={item.hreaf} onClick={() => setIsActive(false)}>
                  <p
                    className={classNames('burgerMenu__navLink', {
          ...
          <div className="burgerMenu__content__footer">
            <Link
              to="/favorites"
              className={classNames('burgerMenu__content__footerBtn', {
                'burgerMenu__content__footerBtn--is-active': favoritesLocation,
              })}
            ...
            <Link
              ...
              className={classNames(
                ...
                {
                  'burgerMenu__content__footerBtn--is-active': cartLocation,
                },
              )}
              onClick={() => setIsActive(false)}
            >

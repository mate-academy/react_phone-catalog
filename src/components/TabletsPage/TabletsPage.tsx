...
export const TabletsPage: React.FC = () => {
  ...
  const tablets = utils.findProduct('tablets');
  const tabletsAvailable = tablets.length;
      ...
      <div className="container">
        <div className="grid">
          <div className="homeHistory">
            ...
            />
            <p className="homeHistory_text">Tablets</p>
          </div>

          <div className="phones_title">
            <p className="phones_title_text">Tablets</p>
            <p className="phones_title_items">{`${tabletsAvailable} models`}</p>
          </div>
              ...
              {tablets.map((tablet, index) => (
                ...
                >
                  <div className="productCard_container">
                    ...
                    <p className="productCard_title">{tablet.name}</p>
                    <div className="productCard_prices">
                      <p className="productCard_fullPrice">{`$${tablet.fullPrice}`}</p>
                      <p className="productCard_price">{`$${tablet.price}`}</p>
                    </div>

                    <div className="productCard_info">
                      <div className="productCard_info_screen">
                        <p className="productCard_info_title">Screen</p>
                        <p className="productCard_info_text">{tablet.screen}</p>
                      </div>
                      ...
                      <div className="productCard_info_ram">
                        ...
                        <p className="productCard_info_text">{tablet.ram}</p>
                      </div>
                    </div>

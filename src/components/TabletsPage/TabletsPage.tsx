    ...
    <>
      <div className="container">
        <div className="breadcrumbs">
          ...
          <p className="breadcrumbs__title">Tablets</p>
        </div>

        <div className="products-page">
          <h1 className="products-page__title">Tablets</h1>
          <p className="products-page__description">24 models</p>

          <div className="products-page__params">
            <div className="products-page__params-sort">
              <p className="products-page__params-sort-title">Sort by</p>
              <select
            ...
            <div className="products-page__params-items">
              <p className="products-page__params-items-title">Items on page</p>
              <select

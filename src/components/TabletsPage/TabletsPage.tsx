...
export const TabletsPage = ({
  ...
  const [gadgets, setGadgets] = useState(tablets);
  ...
  const totalPages =
    elements === 'all' ? 1 : Math.ceil(tablets.length / +elements);
  ...
  const end = elements === 'all' ? tablets.length : start + +elements;
      ...
      <div className="availability">
        <main className="functional">
          <section className="navigate">
            ...
            <p className="navigate__text">Tablets</p>
          </section>

          <h1 className="functional__text">Tablets</h1>
          <p className="functional__models">36 models</p>
              ...
              {visibleCards.map(item => {
                ...
                return (
                  <div key={item.id} className="card mobiles__card">
                    <Link to={`/tablets/${item.id}`} className="card__detail">
                      <img
                        src={item.images[0]}
                        alt="Phone image"

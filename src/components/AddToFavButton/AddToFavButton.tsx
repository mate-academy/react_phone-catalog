...
export const AddToFavButton: React.FC<Props> = ({ product }) => {
  ...
  return (
    <button className={styles.button} onClick={() => toggleFavorite()}>
      ...
      >
        <path
          className={`${styles.path} ${isFavorite ? styles.visible : styles.hidden} ${isFavorite ? styles.red : styles.black}`}
          fillRule="evenodd"
          clipRule="evenodd"
        ...
        />
        <path
          className={`${styles.path} ${!isFavorite ? styles.visible : styles.hidden}`}
          fillRule="evenodd"
          clipRule="evenodd"
          /* eslint-disable-next-line max-len */

    ...
    <>
      <div className="container">
        <div className="breadcrumbs">
          ...
          <p className="breadcrumbs__title">{t('mobile-breadcrumbs')}</p>
        </div>

        <div className="products-page">
          <h1 className="products-page__title">{t('mobile')}</h1>
          <p className="products-page__description">95 {t('models')}</p>

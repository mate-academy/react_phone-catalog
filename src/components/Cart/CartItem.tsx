...
import {
  ...
  decreaseQuantity,
  toggleCart,
} from '@/store/features/products/cartSlice';
  ...
  return (
    <div className="w-full max-w-[752px] min-h-[128px] flex flex-col sm:flex-row items-center gap-6 bg-color-btn-pagin font-mont pb-4 pt-6 px-4 sm:py-0 sm:px-6">
      <div className="flex items-center gap-6">
        ...
        <p className="text-text-color-base-white font-semibold text-sm leading-[21px] w-max-[176px] md:w-[336px] ">
          {product.name}
        </p>
      </div>
      <div className="flex items-center gap-[14px] ">
        <button
          ...
          className={`border border-color-border w-8 h-8 flex items-center justify-center ${
            product.quantity === 1
